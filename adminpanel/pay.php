...
$save2 =mysqli_query($conn,"INSERT into emis(regno,stuname,fname,amt,paydate,mop,tranno,cheqno)VALUE('".$regno."','".$stuname."','".$fname."','".$amount."','".$paydate."','".$mop."','".$tranno."','".$cheqno."' )");
		...
		$save1 =mysqli_query($conn,"INSERT into pendingpay(regno,stuname,fname,email,feepack,packfee,paidamt,pendingfee,pendingpaydate,pendingsts)VALUE('".$regno."','".$stuname."','".$fname."','".$email."','".$feepack."','".$packfee."','".$amount."','".$pending."','".$paydate."','".$sts."')");
