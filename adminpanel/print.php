...
$gst_percentage = $rowc1['gst'];

//$gst_amount = ($rowc1['amount'] * $gst_percentage) / 100;
$formatted_number = ($rowc1['amount'] / 118) * 100;

$gst_amount = number_format($formatted_number, 2);



$total_amount1 = $rowc1['amount'] - $formatted_number;
    ...
    <button onclick="printPage()" id="printbtn" style="position: fixed; top: 50px; right: 10px; padding: 10px; background: #0F2B52; color: white; border: 1px solid #0F2B52; width: 100px;">Print</button>
      <div class="container"  >
		 ...
		 <hr>
		  ...
		  <tr><th style="padding-right:26px;text-align:left;"> Mobile No:</th><td style="padding:5px;"><?php echo $rowc1['mobno']; ?> </td></tr>
		  <tr><th style="padding-right:26px;text-align:left;"> Email Id:</th><td style="padding:5px;"><?php echo $rowc1['email']; ?> </td></tr>
		  ...
		  <tr><th style="padding-right:26px;text-align:left;">Reference No:</th><td style="padding:5px;"><?php echo $rowc1['refno']; ?></td></tr>
    ...
    <thead>
     ...
     <?php } elseif(!empty($rowc1['cheqno'])){?>
      ...
      <tr>
        ...
        <th style="padding:5px;text-align:right;width: 170px;float: right;">Amount &nbsp : </th> <td style="padding:5px;text-align:center;    width: 200px;">Rs.<?php echo $gst_amount; ?>/-</td></tr>
       <tr> <th style="padding:5px;text-align:right;width: 170px;float: right;">GST(<?php echo $rowc1['gst']; ?>%) &nbsp :</th>    <td style="padding:5px;text-align:center;width: 200px;">Rs.<?php echo $total_amount; ?>/-</td></tr>
       <tr> <th style="padding:5px;text-align:right;width: 170px;float: right;">Total &nbsp :</th>  <td style="padding:5px;text-align:center;width: 200px;font-weight:bold;">Rs.<?php echo $rowc1['amount']; ?>/-</td></tr>
