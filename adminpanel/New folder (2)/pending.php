...
<form method="get" action="">
    <div class="container-fluid">
        <div class="form-group row">
            <div class="col-sm-12" style="text-align:center;">
                <button type="button" id="showPaid" style="font-size: 13px;width: 60px;height: 25px;line-height: 25px;padding: 0px;" class="btn btn-success">Paid</button>
                <button type="button" id="showUnpaid" style="font-size: 13px;width: 70px;height: 25px;line-height: 25px;padding: 0px;" class="btn btn-info">Unpaid</button>
 ...
 <div class="col-xl-12 col-md-6 mb-4">
  <h1 style="float: right;color: red;font-size: 18px;font-weight: bold;">User Name:<span style="color: black;"> <?php echo $_SESSION['username']; ?></span></h1>
        ...
        if ($username) {
            $sql = "SELECT * FROM emis WHERE regby='$username' and disablests=0 ORDER BY id ASC";
        } else {
            $sql = "SELECT * FROM emis WHERE 1=0 and disablests=0" ;
        }
		   ...
		   while($show=mysqli_fetch_array($query))
		   {
			   $i++;
				...
				if ($show['status'] == '0') {
				   ...
				   $ap='<a style="text-decoration:none; color:white " class="btn btn-success" href="pstatusupdate.php?regno='.$show['regno'].'&id='.$show['id'].'">Approve</a>';
			   }else{
				   $st='<span style="color:green;">Aproved</span>';
				    //$ap='<a style="text-decoration:none; color:white " class="btn btn-danger" href="">Disable</a>';
					
					$ap='<a style="text-decoration:none; color:white " class="btn btn-danger" href="pdisaprove.php?regno='.$show['regno'].'&id='.$show['id'].'">Disapprove</a>';
			   }
