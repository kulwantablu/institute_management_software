      ...
      <div class="container-fluid">
          ...
          <div class="card  mb-4">
            <div class="card-header py-3">
              <h2 class="m-0 font-weight-bold text-primary" style="text-align:center;">Pay Records</h2>
    ...
    <div class="container-fluid">
        <div class="form-group row">
            <div class="col-sm-12" style="text-align:center;">
                <button type="button" style="font-size: 13px;width: 60px;height: 25px;line-height: 25px;padding: 0px;" id="showPaid" class="btn btn-success btn-xs">Paid</button>
                <button type="button" style="font-size: 13px;width: 70px;height: 25px;line-height: 25px;padding: 0px;" id="showUnpaid" class="btn btn-info btn-xs">Unpaid</button>
  ...
  <h1 style="float: right;color: red;font-size: 18px;font-weight: bold;">User Name:<span style="color: black;"> <?php echo $_SESSION['username']; ?></span></h1>
        ...
        while ($show = mysqli_fetch_array($query)) {
            ...
            if ($show['status'] == '0') {
                ...
                $ap = '<a style="text-decoration:none; color:white" class="btn btn-success" href="statusupdate.php?id=' . $show['id'] . '">Approve</a>';
            } else {
                $st = '<span style="color:green;">Approved</span>';
                $ap = '<a style="text-decoration:none; color:white" class="btn btn-danger" href="disaprove.php?id=' . $show['id'] . '">Disaprove</a>';
            }
