...
if(isset($_GET['reg'])){
	$reg=$_GET['reg'];
     ...
     $save2 =mysqli_query($conn,"INSERT into refund(regno,stuname,fname,amt,remarks,date)VALUE('".$reg."','".$stuname."','".$fname."','".$amt."','".$remarks."','".$date."')");
	 
	 $save3 =mysqli_query($conn,"INSERT into emis(regno,stuname,fname,refund,remarks,paydate)VALUE('".$reg."','".$stuname."','".$fname."','".$amt."','".$remarks."','".$date."')");

$save1=mysqli_query($conn,"update record set amount ='".$total."',refund ='".$amt."',remarks ='".$remarks."' where regno='".$reg."'");


	$save = "update pendingpay set paidamt ='".$total."',refund ='".$amt."' where regno='".$reg."'";
