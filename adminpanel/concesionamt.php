...
if(isset($_GET['reg'])){
	$reg=$_GET['reg'];
     ...
     $save2 =mysqli_query($conn,"INSERT into concession(regno,stuname,fname,amt,date)VALUE('".$reg."','".$stuname."','".$fname."','".$amt."','".$date."')");
               ...
               <form role="form" action="" method="post" enctype="multipart/form-data"style="margin-top:50px;margin-bottom:50px;">
				...
				<div class="form-group row">
				 ...
				 <label>Pending Fee</label>
                    <input type="number" name="pending" value="<?php echo $rowc1['pending']; ?>" class="form-control form-control-user" id="bank_date_incorporation"  readonly required>
                  </div>
				  <div class="col-sm-6">
