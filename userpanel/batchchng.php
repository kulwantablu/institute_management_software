      ...
      <div class="container-fluid">
          ...
          <div class="card  mb-4">
            <div class="card-header py-3">
              <h2 class="m-0 font-weight-bold text-primary" style="text-align:center;">Change Batch</h2>
		   ...
		   $sql2="select * from pack where id='".$show['feepack']."' ORDER BY id ASC";
